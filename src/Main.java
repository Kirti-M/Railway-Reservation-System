...
public class Main {
    ...
    public static void userSigning() {
        ...
        int pro=0;
        for (User value : user) {
            if (value.phoneNo == usMobileNo && value.password.equals(usPassword)) {
                UserFunction();
                pro++;
                break;
            }
    ...
    public static void main(String[] args) {
        User u1 = new User("Kirti","12345",987654321);
        user.add(u1);
        int[][] seat=new int[5][5];
        ArrayList<String> s = new ArrayList<>();
        s.add("1.Delhi");s.add("2.Kanpur");s.add("3.Lucknow");s.add("4.Muzzafarpur");s.add("5.Samastipur");
        Train t1 = new Train("Bihar Express","Delhi","Samastipur",5,5,s,0,seat);
        trains.add(t1);
        int ch;
        do{
